...
public class TimeConversion {
	...
	public static void main(String[] args) {
		...
		ZonedDateTime AusDateTime = currentDateTime.withZoneSameInstant(AustraliaTimeZone);
		...
		System.out.println("Australia time now : " + formatter.format(AusDateTime));
		
		

		// getting the diff b/w two los angeles and dubai times.
		printDurationBetweenTwoDates(losAngelesDateTime, dubaiDateTime);
		printDurationBetweenTwoDates(losAngelesDateTime, AusDateTime);
